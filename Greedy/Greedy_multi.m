%Vaccine Allocation with Greedy Algorithm (Multiple network) 
...
if (parameter)
diary('greedy_multi_para1_multi.log');
filename_results = '../greedy_multi_para1_bgt1.mat';
...
diary('greedy_multi_para2.log');
filename_results = '../greedy_multi_para2_bgt1.mat';
...
if (budget_constrant == 2)
    if (parameter)
diary('greedy_multi_para1.log');
filename_results = '../greedy_multi_para1_bgt2.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('greedy_multi_para2.log');
filename_results = '../greedy_multi_para2_bgt2.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
if (budget_constrant == 3)
    if (parameter)
diary('greedy_multi_para1.log');
filename_results = '../greedy_multi_para1_bgt3.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('greedy_multi_para2.log');
filename_results = '../greedy_multi_para2_bgt3.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
t_33 = 0;
g_33 = 1;
%start iteration for N_1, edges= d_1
while (g_11 <= d_1)
i = 1;
while (i < N_1-t_11+1)
    V_11{qq}(Individual_11{qq}(i),g_11) = 1;
    F_11{qq}(i,g_11) = obj(V_11{qq}(:,g_11),W_1{qq},C_1);
...
%start iteration for N_1, edges= d_2
while (g_12 < d_1+1)
i = 1;
while (i < N_1-t_12+1)
    V_12{qq}(Individual_12{qq}(i),g_12) = 1;
    F_12{qq}(i,g_12) = obj(V_12{qq}(:,g_12),W_2{qq},C_1);
...
%start iteration for N_1, edges= d_3
while (g_13 < d_1+1)
i = 1;
while (i < N_1-t_13+1)
...
%start iteration for for N_2, edges= d_1
while (g_21 < d_2+1)
i = 1;
while (i < N_2-t_21+1)
    V_21{qq}(Individual_21{qq}(i),g_21) = 1;
    F_21{qq}(i,g_21) = obj(V_21{qq}(:,g_21),W_4{qq},C_2);
...
%start iteration for N_2, edges= d_2
while (g_22 < d_2+1)
i = 1;
while (i < N_2-t_22+1)
    V_22{qq}(Individual_22{qq}(i),g_22) = 1;
    F_22{qq}(i,g_22) = obj(V_22{qq}(:,g_22),W_5{qq},C_2);
...
%start iteration for N_2, edges= d_3
while (g_23 < d_2+1)
i = 1;
while (i < N_2-t_23+1)
...
%start iteration for N_3, edges= d_1
while (g_31 < d_3+1)
i = 1;
while (i < N_3-t_31+1)
    V_31{qq}(Individual_31{qq}(i),g_31) = 1;
    F_31{qq}(i,g_31) = obj(V_31{qq}(:,g_31),W_7{qq},C_3);
...
%start iteration for N_3, edges= d_2
while (g_32 < d_3+1)
i = 1;
while (i < N_3-t_32+1)
    V_32{qq}(Individual_32{qq}(i),g_32) = 1;
    F_32{qq}(i,g_32) = obj(V_32{qq}(:,g_32),W_8{qq},C_3);
...
%start iteration for N_3, edges= d_3
while (g_33 < d_3+1)
i = 1;
while (i < N_3-t_33+1)
