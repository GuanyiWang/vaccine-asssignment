%Vaccine Allocation with Greedy Algorithm in Small Netwrok
...
if (parameter)
diary('greedy_small_para1.log');
filename_results = '../greedy_small_para1_bgt1.mat';
...
diary('greedy_small_para2.log');
filename_results = '../greedy_small_para2_bgt1.mat';
...
if (budget_constrant == 2)
    if (parameter)
diary('greedy_small_para1.log');
filename_results = '../greedy_small_para1_bgt2.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('greedy_small_para2.log');
filename_results = '../greedy_small_para2_bgt2.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
if (budget_constrant == 3)
    if (parameter)
diary('greedy_small_para1.log');
filename_results = '../greedy_small_para1_bgt3.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('greedy_small_para2.log');
filename_results = '../greedy_small_para2_bgt3.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
t_33 = 0;
g_33 = 1;
%start iteration for N=500, edges = 1000
while (g_11 <= d_1)
i = 1;
while (i < N_1-t_11+1)
...
%start iteration for N=500, edges = 3000
while (g_12 < d_1+1)
i = 1;
while (i < N_1-t_12+1)
...
%start iteration for N=500, edges = 5000
while (g_13 < d_1+1)
i = 1;
while (i < N_1-t_13+1)
...
%start iteration for N=1000, edges = 1000
while (g_21 < d_2+1)
i = 1;
while (i < N_2-t_21+1)
...
%start iteration for N=1000, edges = 3000
while (g_22 < d_2+1)
i = 1;
while (i < N_2-t_22+1)
...
%start iteration for N=1000, edges = 5000
while (g_23 < d_2+1)
i = 1;
while (i < N_2-t_23+1)
...
%start iteration for N=2000, edges = 1000
while (g_31 < d_3+1)
i = 1;
while (i < N_3-t_31+1)
...
%start iteration for N=2000, edges = 3000
while (g_32 < d_3+1)
i = 1;
while (i < N_3-t_32+1)
...
%start iteration for N=2000, edges = 5000
while (g_33 < d_3+1)
i = 1;
while (i < N_3-t_33+1)
...
%h_4 = plot(G_4);
%highlight(h_4,[V_result_21(1:end)],'NodeColor','r','MarkerSize',6);
%h_4.NodeLabel = {};
%ax = gca;
%exportgraphics(ax,'Greedy_30.pdf','Resolution',300) 
%h_8 = plot(G_8);
%highlight(h_8,[V_result_32(1:end)],'NodeColor','r','MarkerSize',6);
%h_8.NodeLabel = {};
%bx = gca;
%exportgraphics(bx,'Greedy_35.pdf','Resolution',300) 
...
clear F_11 F_12 F_13 F_21 F_22 F_23 F_31 F_32 F_33 C_1 C_2
%clear G_1 G_2 G_3 G_4 G_5 G_6 G_7 G_8 G_9
