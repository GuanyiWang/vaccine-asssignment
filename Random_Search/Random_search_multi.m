...
filename_results = '../random_multi_para1_bgt1.mat';
...
filename_results = '../random_multi_para2_bgt1.mat';
...
if (budget_constrant == 2)
    if (parameter)
diary('random_multi_para1.log');
filename_results = '../random_multi_para1_bgt2.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('random_multi_para2.log');
filename_results = '../random_multi_para2_bgt2.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
if (budget_constrant == 3)
    if (parameter)
diary('random_multi_para1.log');
filename_results = '../random_multi_para1_bgt3.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('random_multi_para2.log');
filename_results = '../random_multi_para2_bgt3.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
%genearte random units for vaccine with N_1
...
%genearte random units for vaccine with N_2      
ii = 1;%set initial parameters for iteration
while (ii<=draws) 
...
%genearte random units for vaccine with N_3
ii = 1;%set initial parameters for iteration
while (ii<=draws) 
...
for g_1 = 1:draws
    F_1{qq}(g_1) = obj(V_assign_1(:,g_1),W_1{qq},C_1);
end

for g_2 = 1:draws
    F_2{qq}(g_2) = obj(V_assign_1(:,g_2),W_2{qq},C_1);
end
...
for g_4 = 1:draws
    F_4{qq}(g_4) = obj(V_assign_2(:,g_4),W_4{qq},C_2);
end

for g_5 = 1:draws
    F_5{qq}(g_5) = obj(V_assign_2(:,g_5),W_5{qq},C_2);
end
...
for g_7 = 1:draws
    F_7{qq}(g_7) = obj(V_assign_3(:,g_7),W_7{qq},C_3);
end

for g_8 = 1:draws
    F_8{qq}(g_8) = obj(V_assign_3(:,g_8),W_8{qq},C_3);
end
