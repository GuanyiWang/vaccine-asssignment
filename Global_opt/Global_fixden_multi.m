...
load('../simulation_small_multi_fixden.mat')
...
budget_constraint = 3; %swtich: choose the capacity constraint level from 1, 2, 3

if (budget_constraint == 1)
if (parameter)
diary('global_multi_para1.log');
filename_results = '../global_fixden_para1_bgt1.mat';
...
filename_results = '../global_fixden_para2_bgt1.mat';
...
if (budget_constraint == 2)
    if (parameter)
diary('global_multi_para1.log');
filename_results = '../global_fixden_para1_bgt2.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('global_multi_para2.log');
filename_results = '../global_fixden_para2_bgt2.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
if (budget_constraint == 3)
    if (parameter)
diary('global_multi_para1.log');
filename_results = '../global_fixden_para1_bgt3.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('global_multi_para2.log');
filename_results = '../global_fixden_para2_bgt3.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
i = i+1;
    ...
    F_12{qq}(ii) = obj(V_12(:,ii),W_2{qq},C_1,g_1);%calculate the value for objective function with adjacency matrix adj_2
    ii = ii+1;
end
...
i = i+1;
    ...
    F_13(ii) = obj(V_13(:,ii),W_3,C_1,g_1);%calculate the value for objective function with adjacency matrix adj_3
    ii = ii+1;
end
...
i = i+1;
    ...
    F_21{qq}(ii) = obj(V_21(:,ii),W_4{qq},C_2,g_2);%calculate the value for objective function with adjacency matrix adj_4
    ii = ii+1;
end
...
i = i+1;
    ...
    F_22{qq}(ii) = obj(V_22(:,ii),W_5{qq},C_2,g_2);%calculate the value for objective function with adjacency matrix adj_5
    ii = ii+1;
end
...
i = i+1;
    ...
    F_23(ii) = obj(V_23(:,ii),W_6,C_2,g_2);%calculate the value for objective function with adjacency matrix adj_6
    ii = ii+1;
end
...
i = i+1;
    ...
    F_31{qq}(ii) = obj(V_31(:,ii),W_7{qq},C_3,g_3);%calculate the value for objective function with adjacency matrix adj_7
    ii = ii+1;
end
...
i = i+1;
    ...
    F_32{qq}(ii) = obj(V_32(:,ii),W_8{qq},C_3,g_3);%calculate the value for objective function with adjacency matrix adj_8
    ii = ii+1;
end
...
i = i+1;
    ...
    F_33(ii) = obj(V_33(:,ii),W_9,C_3,g_3);%calculate the value for objective function with adjacency matrix adj_9
    ii = ii+1;
end
...
%take average value of outcome variables across different networks
ww = 1;
while (ww<=times)
