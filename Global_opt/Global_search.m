...
i = i+1;
    ...
    F_11(ii) = obj(V_11(:,ii),W_1,C_1);%calculate the value for objective function with adjacency matrix adj_1
    ii = ii+1;
end
...
i = i+1;
    ...
    F_12(ii) = obj(V_12(:,ii),W_2,C_1);%calculate the value for objective function with adjacency matrix adj_2
    ii = ii+1;
end
...
i = i+1;
    ...
    F_21(ii) = obj(V_21(:,ii),W_4,C_2);%calculate the value for objective function with adjacency matrix adj_4
    ii = ii+1;
end
...
i = i+1;
    ...
    F_22(ii) = obj(V_22(:,ii),W_5,C_2);%calculate the value for objective function with adjacency matrix adj_5
    ii = ii+1;
end
...
i = i+1;
    ...
    F_31(ii) = obj(V_31(:,ii),W_7,C_3);%calculate the value for objective function with adjacency matrix adj_7
    ii = ii+1;
end
...
i = i+1;
    ...
    F_32(ii) = obj(V_32(:,ii),W_8,C_3);%calculate the value for objective function with adjacency matrix adj_8
    ii = ii+1;
end
