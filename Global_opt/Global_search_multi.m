...
i = i+1;
    ...
    F_11{qq}(ii) = obj(V_11(:,ii),W_1{qq},C_1);%calculate the value for objective function with adjacency matrix adj_1
    ii = ii+1;
end
...
i = i+1;
    ...
    F_12{qq}(ii) = obj(V_12(:,ii),W_2{qq},C_1);%calculate the value for objective function with adjacency matrix adj_2
    ii = ii+1;
end
...
i = i+1;
    ...
    F_13(ii) = obj(V_13(:,ii),W_3,C_1);%calculate the value for objective function with adjacency matrix adj_3
    ii = ii+1;
end
...
i = i+1;
    ...
    F_21{qq}(ii) = obj(V_21(:,ii),W_4{qq},C_2);%calculate the value for objective function with adjacency matrix adj_4
    ii = ii+1;
end
...
i = i+1;
    ...
    F_22{qq}(ii) = obj(V_22(:,ii),W_5{qq},C_2);%calculate the value for objective function with adjacency matrix adj_5
    ii = ii+1;
end
...
i = i+1;
    ...
    F_23(ii) = obj(V_23(:,ii),W_6,C_2);%calculate the value for objective function with adjacency matrix adj_6
    ii = ii+1;
end
...
i = i+1;
    ...
    F_31{qq}(ii) = obj(V_31(:,ii),W_7{qq},C_3);%calculate the value for objective function with adjacency matrix adj_7
    ii = ii+1;
end
...
i = i+1;
    ...
    F_32{qq}(ii) = obj(V_32(:,ii),W_8{qq},C_3);%calculate the value for objective function with adjacency matrix adj_8
    ii = ii+1;
end
...
i = i+1;
    ...
    F_33(ii) = obj(V_33(:,ii),W_9,C_3);%calculate the value for objective function with adjacency matrix adj_9
    ii = ii+1;
end
