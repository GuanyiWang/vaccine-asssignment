...
load('../random_fixden_para1_bgt1.mat');
Y_21_2 = Y_21_ave;
Y_22_2 = Y_22_ave;
Y_23_2 = Y_23_ave;
Y_31_2 = Y_31_ave;
...
load('../random_fixden_para2_bgt1.mat');
Y_21_2 = Y_21_ave;
Y_22_2 = Y_22_ave;
Y_23_2 = Y_23_ave;
Y_31_2 = Y_31_ave;
...
load('../random_fixden_para1_bgt2.mat');
Y_21_2 = Y_21_ave;
Y_22_2 = Y_22_ave;
Y_23_2 = Y_23_ave;
Y_31_2 = Y_31_ave;
...
load('../random_fixden_para2_bgt2.mat');
Y_21_2 = Y_21_ave;
Y_22_2 = Y_22_ave;
Y_23_2 = Y_23_ave;
Y_31_2 = Y_31_ave;
...
load('../random_fixden_para1_bgt3.mat');
Y_21_2 = Y_21_ave;
Y_22_2 = Y_22_ave;
Y_23_2 = Y_23_ave;
Y_31_2 = Y_31_ave;
...
load('../random_fixden_para2_bgt3.mat');
Y_21_2 = Y_21_ave;
Y_22_2 = Y_22_ave;
Y_23_2 = Y_23_ave;
Y_31_2 = Y_31_ave;
...
figure(1)
%plot the node for density=0.1 (x-axis is the result from greedy algorithm, and y-axis is the result from random allocation)
scatter(Y21_1_1(1), Y21_2_1(1), sz_1,'o', 'MarkerEdgeColor',plot_1_color ,'LineWidth',1.5)
hold on;
...
hold on;
%plot the node for density=1 (x-axis is the result from greedy algorithm, and y-axis is the result from random allocation)
...
dim_2 = [.55 .55 .35 .32];%the location of rectangle for density=0.1
annotation('rectangle',dim_2,'Color','red')%circle the area of density = 0.1
x_dens_05 = [0.7 0.75];
y_dens_05 = [0.45 0.64];
annotation('textarrow',x_dens_05,y_dens_05,'String','density = 0.1');%add word 'edges = 10N'
