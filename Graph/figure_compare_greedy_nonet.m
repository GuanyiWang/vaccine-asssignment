...
figure(1)
%plot the node for edges = 10N (x-axis is the result from greedy algorithm, and y-axis is the result from TWNI)
scatter(Y21_1_1(2), Y21_2_1(2), sz_1,'o', 'MarkerEdgeColor',plot_1_color ,'LineWidth',1.5)%plot the node for N=500
hold on;
...
hold on;
%plot the node for edges = full (x-axis is the result from greedy algorithm, and y-axis is the result from TWNI)
