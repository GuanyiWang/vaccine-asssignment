...
if (color)
   ...
   save_name_500 =  'greedy_nonet_500_color.pdf';
   save_name_800 =  'greedy_nonet_800_color.pdf';
else
    plot_1_color = [0.2 0.2 0.2];
    plot_2_color = [0.5 0.5 0.5];
    plot_3_color = [0.8 0.8 0.8];
   save_name_500 =  'greedy_nonet_500_black.pdf';
   save_name_800 =  'greedy_nonet_800_black.pdf';
end
