...
if (color)
   ...
   save_name_500 =  'random_nonet_500_color.pdf';%file name for N=500, color
   save_name_800 =  'random_nonet_800_color.pdf';%file name for N=800, color
else
    plot_1_color = [0.2 0.2 0.2];
    plot_2_color = [0.5 0.5 0.5];
    plot_3_color = [0.8 0.8 0.8];
   save_name_500 =  'random_nonet_500_black.pdf';%file name for N=500, Black
   save_name_800 =  'random_nonet_800_black.pdf';%file name for N=800, Black
end
...
Y_32_1 = Y_32_ave;
Y_33_1 = Y_33_ave;
Y21_1_1 = [Y_21_1,Y_22_1,Y_23_1];%save the node for random allocation, parameter 1 and budget constraint 1, N=500
Y31_1_1 = [Y_31_1,Y_32_1,Y_33_1];%save the node for random allocation, parameter 1 and budget constraint 1, N=800
...
Y_32_1 = Y_32_ave;
Y_33_1 = Y_33_ave;
Y22_1_1 = [Y_21_1,Y_22_1,Y_23_1];%save the node for random allocation, parameter 2 and budget constraint 1, N=500
Y32_1_1 = [Y_31_1,Y_32_1,Y_33_1];%save the node for random allocation, parameter 2 and budget constraint 1, N=800
...
Y_32_1 = Y_32_ave;
Y_33_1 = Y_33_ave;
Y21_1_2 = [Y_21_1,Y_22_1,Y_23_1];%save the node for random allocation, parameter 1 and budget constraint 2, N=500
Y31_1_2 = [Y_31_1,Y_32_1,Y_33_1];%save the node for random allocation, parameter 1 and budget constraint 2, N=800
...
Y_32_1 = Y_32_ave;
Y_33_1 = Y_33_ave;
Y22_1_2 = [Y_21_1,Y_22_1,Y_23_1];%save the node for random allocation, parameter 2 and budget constraint 2, N=500
Y32_1_2 = [Y_31_1,Y_32_1,Y_33_1];%save the node for random allocation, parameter 2 and budget constraint 2, N=800
...
Y_32_1 = Y_32_ave;
Y_33_1 = Y_33_ave;
Y21_1_3 = [Y_21_1,Y_22_1,Y_23_1];%save the node for random allocation, parameter 1 and budget constraint 3, N=500
Y31_1_3 = [Y_31_1,Y_32_1,Y_33_1];%save the node for random allocation, parameter 1 and budget constraint 3, N=800
...
Y_32_1 = Y_32_ave;
Y_33_1 = Y_33_ave;
Y22_1_3 = [Y_21_1,Y_22_1,Y_23_1];%save the node for random allocation, parameter 2 and budget constraint 3, N=500
Y32_1_3 = [Y_31_1,Y_32_1,Y_33_1];%save the node for random allocation, parameter 2 and budget constraint 3, N=800
...
Y32_2_3 = [Y_31_2,Y_32_2,Y_33_2];%save the node for TWNI, parameter 2 and budget constraint 3, N=800
...
figure(1)
%plot the node for edges = 10N (x-axis is the result from random allocation, and y-axis is the result from TWNI)
...
hold on;
%plot the node for edges = full (x-axis is the result from random allocation, and y-axis is the result from TWNI)
