...
%(Multiple network) with fixed density
...
filename_results = '../nonet_fixden_para1_bgt1.mat';
...
filename_results = '../nonet_fixden_para2_bgt1.mat';
...
if (budget_constraint == 2)
    if (parameter)
diary('nonet_multi_para1.log');
filename_results = '../nonet_fixden_para1_bgt2.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('nonet_multi_para2.log');
filename_results = '../nonet_fixden_para2_bgt2.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
if (budget_constraint == 3)
    if (parameter)
diary('nonet_multi_para1.log');
filename_results = '../nonet_fixden_para1_bgt3.mat';
beta_11 = 0.7; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.5; %infection rate from group 1 to group 2
beta_22 = 0.6; %infection rate between group 2 and group 2
...
diary('nonet_multi_para2.log');
filename_results = '../nonet_fixden_para2_bgt3.mat';
beta_11 = 0.8; %infection rate between group 1 and group 1
beta_12 = 0.5; %infection rate from group 2 to group 1
beta_21 = 0.7; %infection rate from group 1 to group 2
beta_22 = 0.7; %infection rate between group 2 and group 2
...
F_result_12{qq} = obj(V_1,W_2{qq},C_1,g_1);
F_result_13 = obj(V_1,W_3,C_1,g_1);
F_result_21{qq} = obj(V_2,W_4{qq},C_2,g_2);
F_result_22{qq} = obj(V_2,W_5{qq},C_2,g_2);
F_result_23 = obj(V_2,W_6,C_2,g_2);
F_result_31{qq} = obj(V_3,W_7{qq},C_3,g_3);
F_result_32{qq} = obj(V_3,W_8{qq},C_3,g_3);
F_result_33 = obj(V_3,W_9,C_3,g_3);
