%Random Small Network Generation (Multiple)
%Author: Toru kitagawa and Guanyi Wang

clear all
filename = '../simulation_small_multi.mat';
% random graph
%randomly generate adjacency matrix
rng(0)
times = 20; %define the times of random graph generation
% for N =25
N_1 = 25;
e_1 = 7*N_1;
for i = 1:times
adj_1{i} = random_graph(N_1,[],e_1);
end
